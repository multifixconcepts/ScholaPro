...
- [**Windows**](https://gitlab.com/francoisjacquet/scholapro/wikis/Instalar-ScholaPro-en-Windows)
- [**Mac**](https://gitlab.com/francoisjacquet/scholapro/-/wikis/How-to-install-ScholaPro-on-Mac-(macOS,-OS-X)) (en inglés)
- [**cPanel**](https://gitlab.com/francoisjacquet/scholapro/wikis/How-to-install-ScholaPro-on-cPanel) (en inglés)
- [**Softaculous**](https://gitlab.com/francoisjacquet/scholapro/-/wikis/How-to-install-ScholaPro-with-Softaculous) (en inglés)
- [**Docker**](https://github.com/francoisjacquet/docker-scholapro) (en inglés)
- **Ubuntu** (o cualquier distribución Linux basada en Debian), ver abajo

En caso de que no disponga de los recursos técnicos para instalar ScholaPro, puede elegir un plan alojado en https://www.scholapro.com/es


Instalar el paquete
-------------------

Descomprima la [última versión](https://www.scholapro.org/es/download/) de ScholaPro, o clona el repositorio git (y haga el checkout del tag de la [última versión](https://gitlab.com/francoisjacquet/scholapro/-/releases)) en un directorio accesible con el navegador. Edita el archivo `config.inc.sample.php` para definir las variables de configuración apropiadas, y renombralo `config.inc.php`.
...
- `$RosarioPath` Camino completo hacia la instalación de ScholaPro.
...
- `define( 'ROSARIO_POST_MAX_SIZE_LIMIT', 16 * 1024 * 1024 );` Limitar el tamaño de `$_POST` (16MB por defecto). Detalles [acá](https://gitlab.com/francoisjacquet/scholapro/-/blob/mobile/Warehouse.php#L322).
...
Ahora, está listo para configurar la base de datos de ScholaPro. Si tiene acceso al símbolo del sistema de su servidor, abra una ventana del terminal, y sigua estas instrucciones.
...
[Guía de Configuración Rápida](https://www.scholapro.org/es/quick-setup-guide/)

[Asegurar ScholaPro](https://gitlab.com/francoisjacquet/scholapro/-/wikis/Secure-ScholaPro)
