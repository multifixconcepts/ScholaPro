...
- Add French & Spanish translation for "Icon successfully uploaded." in scholapro.po
...
- Fix typo in English string, update translations in Rollover.php & scholapro.mo
...
- Fix SQL transcript_grades view, grades were duplicated for each school year in scholapro.sql & Update.fnc.php
...
- Use ScholaPro\Widgets in Widgets.fnc.php
...
- Use ScholaPro\StaffWidgets in StaffWidgets.fnc.php
...
- SQL add PRIMARY KEY to staff_exceptions table in scholapro.sql
- SQL profile_exceptions & staff_exceptions tables: Add Admin Student Payments Delete restriction in Update.fnc.php & scholapro.sql
...
Changes in 8.4
--------------
- SQL gradebook_grades table: Change comment column type to text in Update.fnc.php & scholapro.sql
...
- SQL accounting_incomes table: Add FILE_ATTACHED column in Update.fnc.php & scholapro.sql
...
- SQL accounting_payments table: Add FILE_ATTACHED column in Update.fnc.php & scholapro.sql
- SQL billing_payments table: Add FILE_ATTACHED column in Update.fnc.php & scholapro.sql
- Add help note for student deletion & translate in Help_en.php & help.po
- Add ScholaPro URL to image path in MarkDownHTML.fnc.php
...
- SQL accounting_salaries table: Add FILE_ATTACHED column in Update.fnc.php & scholapro.sql
- Add File Attached to Salaries in Salaries.php & Accounting/functions.inc.php
- SQL billing_fees table: Add FILE_ATTACHED column in Update.fnc.php & scholapro.sql
...
- Default theme is now FlatSIS in scholapro.sql
...
- Remove Daily Totals program from Student Billing & Accounting menus in Menu.php & scholapro.sql
...
- Remove Absence Summary program from Attendance menu in Menu.php, Help_en.php & scholapro.sql
...
Changes in 7.9
--------------
- Update default School Year to 2021 in scholapro.sql & config.inc.sample.php
...
- SQL fix Report Card Grades insert in scholapro_fr.sql
...
- French translation: replace "Effacer" with "Supprimer" in scholapro.po & help.po
...
- Fix 'School' translation when using MoTranslator in Schedule.inc.php & scholapro.po
...
- Merge Schedule Report & Master Schedule Report in Menu.php, MasterScheduleReport.php, ScheduleReport.php & scholapro.sql
- Add Students column to report in RequestsReport.php
- Merge Requests Report & Unfilled Requests in Menu.php, RequestsReport.php, UnfilledRequests.php, Scheduler.php, Help_en.php & scholapro.sql
- Merge Average Daily Attendance & Average Attendance by Day in Menu.php, Percent.php, Help_en.php, help.po & scholapro.sql
...
- SQL no access to Custom "My Report" program for admin by default in scholapro.sql
