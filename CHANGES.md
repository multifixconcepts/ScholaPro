...
Changes in 12.5
---------------
- Fix regression since 12.5: trigger change event when selecting date from calendar in calendar-setup.js
...
- Default School Year: 2025 (2025-2026) in config.inc.sample.php, scholapro.sql & scholapro_mysql.sql

Changes in 12.3
---------------
- Multilingual course title: use ParseMLField(), program wide
- Multilingual course title: SQL change title column type from varchar(100) to text in Update.fnc.php, scholapro.sql & scholapro_mysql.sql
...
- Security: Cache killer: use file last modified time hash instead of ScholaPro version in Warehouse.php
...
- Fix PHP fatal error Unknown format specifier "," in Greek translation in locale/el_GR.utf8/scholapro.po
...
Changes in 12.2.1
-----------------
- PostgreSQL on cPanel fix ERROR: must be owner of language plpgsql in scholapro.sql & Update.fnc.php
- PostgreSQL create plpgsql extension if not exists in scholapro.sql
...
- Update French & Spanish translations in scholapro.po
- Security: move ScholaPro version from Login screen to Portal in index.php & Portal.php
...
- SQL remove deprecated columns in scholapro.sql & scholapro_mysql.sql
- Remove php.ini safe_mode check, deprecated since PHP 5.3 in Portal.php
- Send ScholaPro version in Addon.fnc.php
...
- PostgreSQL remove deprecated create_language_plpgsql() in scholapro.sql
- SQL N/A grade (empty GPA value) does not affect GPA in scholapro.sql, scholapro_mysql.sql & Update.fnc.php
- CSS themes small fixes + Reduce multiple select2 font size in stylesheet.css & colors.css
- SQL fix Breakoff percentages for Main grading scale in scholapro_fr.sql & scholapro_es.sql
...
Changes in 12.1
---------------
- MySQL set CREATED_AT on INSERT in scholapro_mysql.sql
...
- SQL Add Admin Delete Permission to profile_exceptions & staff_exceptions tables in Update.fnc.php, scholapro.sql & scholapro_mysql.sql
...
Changes in 11.8
---------------
- SQL performance: reduce staff table row size (was 3.8KB) & remove HOMEROOM column in Rollover.php, scholapro.sql & scholapro_mysql.sql
...
- Update default school year to 2024 in config.inc.sample.php, scholapro.sql & scholapro_mysql.sql
...
Changes in 11.5
---------------
- Moodle plugin: Add REST API protocol in plugins/Moodle/, scholapro.sql & scholapro_mysql.sql
...
Changes in 11.4.4
-----------------
- Fix SQL transcript_grades view for History Marking Periods of existing school years in scholapro.sql, scholapro_mysql.sql & Update.fnc.php
...
- PostgreSQL fix limit set_updated_at_triggers() to current schema in scholapro.sql
- SQL add Comment to every grade of the Main scale in scholapro.sql & scholapro_mysql.sql
...
- Add "Report a bug" link to Resources in scholapro.sql, scholapro_mysql.sql, scholapro_es.sql & scholapro_fr.sql
...
- Fix regression since 4.7 SQL set_class_rank_mp() Class Rank calculation when various school years in scholapro.sql, scholapro_mysql.sql & Update.fnc.php
...
- SQL add NOT NULL for student_medical type, student_medical_alerts title & student_medical_visits school_date columns in scholapro.sql & scholapro_mysql.sql
...
- Update French & Spanish translations in scholapro.po & help.po
...
- SQL add FOREIGN KEY to transaction_id column in scholapro.sql & scholapro_mysql.sql
- SQL Add MENU_ITEM_ID column to food_service_transaction_items & food_service_staff_transaction_items tables in Update.fnc.php, scholapro.sql & scholapro_mysql.sql
...
- SQL Add CREATED_BY column to billing_fees & billing_payments tables in Update.fnc.php, scholapro.sql & scholapro_mysql.sql
...
- SQL new default is 0 for ATTENDANCE_FULL_DAY_MINUTES Config option in scholapro.sql & scholapro_mysql.sql
...
- FS transaction item ID references food_service_menu_items(menu_item_id) in ServeMenus.php, scholapro.sql & scholapro_mysql.sql
...
- SQL set min Credits to 0 & fix division by zero error in Courses.fnc.php, scholapro.sql & scholapro_mysql.sql
...
- SQL access_log: deprecate LOGIN_TIME column, use CREATED_AT instead in index.php, AccessLog.php, Dashboard.inc.php, scholapro.sql & scholapro_mysql.sql
- SQL portal_notes & portal_polls: deprecate PUBLISHED_DATE column, use CREATED_AT instead in PortalNotes.php, PortalPolls.php, Portal.php, scholapro.sql & scholapro_mysql.sql
...
- Increase default Password Strength from 1 to 2 in scholapro.sql & scholapro_mysql.sql
- PostgreSQL rename "rank" to "class_rank" in set_class_rank_mp() for consistency with MySQL in scholapro.sql
...
- Move "Progress Reports" from Teacher Programs to Grades menu (admin) in Grades/Menu.php, ProgressReports.php, scholapro.sql & scholapro_mysql.sql
...
- SQL add accounting_categories table in scholapro.sql & scholapro_mysql.sql
- Add Categories program to Accounting module in Categories.php, Menu.php, scholapro.sql & scholapro_mysql.sql
...
- Translate Weight Assignments option to French & Spanish in scholapro.pot & scholapro.po
