...
## ScholaPro Educational Management Platform

New in 12.4
-----------

**Breaking change**, please upgrade the following add-on:
- [TinyMCE Record Audio Video](https://www.scholapro.org/plugins/tinymce-record-audio-video/) plugin version 10.4+ (April, 2025)
...
[Meeting](https://www.scholapro.org/modules/meeting/) & Meeting Premium modules, sponsored by English National Program, France
...
[PDF Header Footer Premium](https://www.scholapro.org/plugins/pdf-header-footer/) plugin
...
[Class Diary Premium](https://www.scholapro.org/modules/class-diary/) module
...
Security:
- Move ScholaPro version number from login screen to Portal (admin only)
...
Grades
- Grading Scales: "N/A" grade (empty GPA value & Breakoff) is now a [grade that does not affect GPA](https://www.scholapro.org/forum/d/1238-is-there-a-way-to-add-a-grade-that-does-not-affect-the-gpa)

[Microsoft Social Login](https://www.scholapro.org/plugins/microsoft-social-login/) plugin
...
[Entry and Exit](https://www.scholapro.org/modules/entry-exit/) module

[NFC/QR Actions](https://www.scholapro.org/modules/nfc-qr-actions/) module

[TTHotel Smart Locks](https://www.scholapro.org/modules/tthotel-smart-locks/) module

The above modules are sponsored by AT group, Slovenia

[Email Parents](https://www.scholapro.org/modules/email-parents/) module
- Send Days Absent (for a specific period), sponsored by Paris'Com Sup, France

[Certificate](https://www.scholapro.org/modules/certificate/) module
- Add background image / watermark, sponsored by Paris'Com Sup, France

[Messaging Premium](https://www.scholapro.org/modules/messaging/) module
...
- [Email SMTP](https://www.scholapro.org/plugins/email-smtp/) plugin version 10.4+ (March, 2024)
- [Email Log](https://gitlab.com/francoisjacquet/Email_Log) module version 1.2+ (March, 2024)
- [Reports](https://www.scholapro.org/modules/reports/) module version 10.6+ (May, 2024)
- [Human Resources](https://www.scholapro.org/modules/human-resources/) module version 10.2+ (August, 2023)
- [Calendar Schedule View](https://www.scholapro.org/plugins/calendar-schedule-view/) plugin version 10.2+ (July, 2024)
- [Quiz](https://www.scholapro.org/modules/quiz/) module version 10.7+ (December, 2024)
...
Those files are now uploaded under a subdirectory of `assets/Fileuploads/`. See the [`$FileUploadsPath`](https://gitlab.com/francoisjacquet/scholapro/-/blob/mobile/INSTALL.md#optional-variables) config variable.

Add-on installations statistics (on first activation). To disable, use the [`ROSARIO_DISABLE_USAGE_STATISTICS`](https://gitlab.com/francoisjacquet/scholapro/-/blob/mobile/INSTALL.md#optional-variables) config constant.

[New translations](locale/REFERENCE.md) (99% completed, includes help), thanks to Georgios Katakalos
- Greek (Greece)
- Turkish (Turkey)

[Stripe Registration](https://www.scholapro.org/plugins/stripe-registration/) plugin, sponsored by English National Program, France

[Library Premium](https://www.scholapro.org/modules/library/)
- Quick Loan: quickly search and lend a document to a user or student, sponsored by AT group, Slovenia

[Billing Elements](https://www.scholapro.org/modules/billing-elements/)
...
[Staff and Parents Import](https://www.scholapro.org/modules/staff-parents-import/) module
- Assign users to a specific school, sponsored by LGBTQInnos, USA

[Templates](https://www.scholapro.org/plugins/templates) plugin
- Integrates with the [Messaging Premium](https://www.scholapro.org/modules/messaging/) module, sponsored by @Hirama666
...
School
- Rollover: update the default school year (if the `config.inc.php` file can be edited). [Rollover Guide PDF](https://www.scholapro.org/documentation/) update
...
[Student Billing Premium](https://www.scholapro.org/modules/student-billing-premium/): link your [Stripe](https://stripe.com/) account and accept payments. Stripe is [available in 46 countries](https://stripe.com/global).
...
[Email Log](https://www.scholapro.org/modules/email-log) module
...
[Food Service Premium](https://www.scholapro.org/modules/food-service-premium/) module, sponsored by AT group, Slovenia

[SMS Premium](https://www.scholapro.org/modules/sms/)
...
[Lesson Plan](https://www.scholapro.org/modules/lesson-plan/) module, sponsored by Rousseau International, Cameroon

[Class Diary Premium](https://www.scholapro.org/modules/class-diary/#premium-module)
...
[Grades Import](https://www.scholapro.org/modules/grades-import/)
- Import Final Grades, sponsored by Univers Frère Raphaël, Haiti

[Students Import Premium](https://www.scholapro.org/modules/students-import/#premium-module)
...
ScholaPro can now be installed with [Softaculous](https://gitlab.com/francoisjacquet/scholapro/-/wikis/How-to-install-ScholaPro-with-Softaculous)
...
[Student Billing Premium](https://www.scholapro.org/modules/student-billing-premium/)
...
[SMS Premium](https://www.scholapro.org/modules/sms/): new gateway, WhatsApp Cloud API, sponsored by EspaceHitech.mg


New in 10.4
-----------

[Hostel](https://www.scholapro.org/modules/hostel/) module
...
[Installation tutorial for Mac (macOS, OS X)](https://gitlab.com/francoisjacquet/scholapro/-/wikis/How-to-install-ScholaPro-on-Mac-(macOS,-OS-X))
...
Know more about ScholaPro version 10 and MySQL support in this [blog post](https://www.scholapro.org/blog/#mysql-support).
...
[Quiz Premium](https://www.scholapro.org/modules/quiz/)
...
[Email Students](https://www.scholapro.org/modules/email-students/)
...
[Email Parents](https://www.scholapro.org/modules/email-parents/)
- Automatically send (child's) Birthday notifications
- Automatically send Payment reminders (outstanding fees), X days before or after Due date
Sponsored by Rousseau International school

[SMS Premium](https://www.scholapro.org/modules/sms/#premium-module)
...
[Quiz Premium](https://www.scholapro.org/modules/quiz/#premium-module) module, sponsored by Dzung Do
...
[Class Diary](https://www.scholapro.org/modules/class-diary/) module


New in 7.7
----------

[Google Social Login](https://www.scholapro.org/plugins/google-social-login/) plugin, sponsored by Santa Cecilia school
...
[Automatic Attendance](https://www.scholapro.org/plugins/automatic-attendance/) plugin, sponsored by Paris'Com Sup
...
[Certificate](https://www.scholapro.org/modules/certificate/) module, sponsored by Paris'Com Sup

[Email](https://www.scholapro.org/modules/email/) module:
...
[Staff Absences](https://www.scholapro.org/modules/staff-absences/) module, sponsored by English National Program
...
[Student Billing Premium](https://www.scholapro.org/modules/student-billing-premium/) module:
...
[SMS Premium](https://www.scholapro.org/modules/sms/#premium-module) module:
...
School
- Configuration: Add-on zip upload (check [INSTALL.md](https://gitlab.com/francoisjacquet/scholapro/-/blob/mobile/INSTALL.md#optional-variables) to disable).

[Students Import Premium](https://www.scholapro.org/modules/students-import/#premium-module) module:
...
[Jitsi Meet](https://www.scholapro.org/modules/jitsi-meet/) module, sponsored by Santa Cecilia school.


New in 6.1
----------

[Students Import](https://www.scholapro.org/modules/students-import/) module:
...
[TinyMCE Record Audio Video](https://www.scholapro.org/plugins/tinymce-record-audio-video/) plugin
...
[Paypal Registration](https://www.scholapro.org/plugins/paypal-registration/) plugin
...
- [Staff and Parents Import](https://www.scholapro.org/modules/staff-parents-import/) module to version 1.3
- [SMS](https://www.scholapro.org/modules/sms/) + Premium modules to version 1.5
- [Public Pages Premium](https://www.scholapro.org/plugins/public-pages/) plugin to version 1.5
...
[iCalendar](https://www.scholapro.org/plugins/icalendar/) plugin
...
[Grades Import](https://www.scholapro.org/modules/grades-import/) module, sponsored by Instituto Japon.

[Iomad](https://www.scholapro.org/plugins/iomad/) plugin (multi-tenancy Moodle), sponsored by LearnersPlatform
...
[Public Pages Premium](https://www.scholapro.org/plugins/public-pages/)
...
[Billing Elements](https://www.scholapro.org/modules/billing-elements/) module, sponsored by English National Program.


New in 5.6
----------

[SMS](https://www.scholapro.org/modules/sms/) module.

[Library Premium](https://www.scholapro.org/modules/library/) module.

[TinyMCE Formula](https://www.scholapro.org/plugins/tinymce-formula/) plugin.
...
[LDAP](https://www.scholapro.org/plugins/ldap/) plugin
...
[Relatives](https://www.scholapro.org/plugins/relatives/) plugin, sponsored by Asian Hope
...
[Setup Assistant](https://www.scholapro.org/plugins/setup-assistant/) plugin
...
[Timetable Import](https://www.scholapro.org/modules/timetable-import/) module

[Discipline Score](https://www.scholapro.org/plugins/discipline-score/) plugin
...
[Calendar Schedule View](https://www.scholapro.org/plugins/calendar-schedule-view/) plugin, sponsored by Revamp Consulting.
...
[Public Pages](https://www.scholapro.org/plugins/public-pages/) plugin

[Email Alerts](https://www.scholapro.org/modules/email-alerts/) module, sponsored by Santa Cecilia school.
...
[Library](https://www.scholapro.org/modules/library/) module
...
[Email Students](https://www.scholapro.org/modules/email-students/) module
...
[Quiz](https://www.scholapro.org/modules/quiz/) module
...
[Email SMTP](https://www.scholapro.org/plugins/email-smtp/) plugin
...
[Staff and Parents Import](https://www.scholapro.org/modules/staff-parents-import/) module, sponsored by @abogadeer
...
New [PDF Header Footer](https://www.scholapro.org/plugins/pdf-header-footer) plugin
...
[MarkDown](https://gitlab.com/francoisjacquet/scholapro/wikis/Markdown-Cheatsheet) support for Large text fields
...
Open ScholaPro links in new tab
...
Translation
- Every string in ScholaPro now translatable
