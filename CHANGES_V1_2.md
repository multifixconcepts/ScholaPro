...
- Add SELECT\_OPTIONS column to school_fields table in Update.fnc.php & scholapro.sql
...
- Update database for Admin User Profile restriction in scholapro.sql & Update.fnc.php
...
- Update database for Admin Schools restriction in scholapro.sql & Update.fnc.php
...
- Gender & Ethnicity Student Fields not Required by default in scholapro.sql
...
- Update Default School Year to 2016 in scholapro.sql & config.inc.sample.php
...
- Place ScholaPro version, disclaimer & copyright inside "About" toggle in index.php
...
- Add course_period_school_periods_id to course_period_school_periods table primary key in scholapro.sql
...
- Create school_fields_seq Sequence in scholapro.sql & Update.fnc.php
...
- Add STUDENTS_EMAIL_FIELD to config table in scholapro.sql & Configuration.php
...
- Update official site URLs: HTTPS on scholapro.org
...
- Send emails from programname instead of scholapro in SendEmail.fnc.php
...
Changes in 2.8.15
-----------------
- 2015-2016 School Year update in scholapro.sql & config.inc.sample.php
...
Changes in 2.8.12
-----------------
- Fix #102 error language "plpgsql" does not exist in scholapro.sql
...
Changes in 2.8.7
----------------
- Fix #101 cookie domain if ScholaPro installed at server www root in Warehouse.php
...
- Fix SQL error relation "custom" does not exist in scholapro.sql
...
- Remove table CUSTOM in scholapro.sql
...
- send email from scholapro@[domain] in NotifyParents.php
...
- Allow students to change their password by default in scholapro.sql
...
- history grades in Transripts in Transcripts.php & scholapro.sql
...
- Bigger config values capacity to accept serialized variables in scholapro.sql
...
- Send email from scholapro@[site_domain] in SendEmail.fnc.php
...
- Note: all the modules coming with ScholaPro will be activated
...
- Add the Accounting module to the config.inc.php file, see https://gitlab.com/francoisjacquet/scholapro/blob/mobile/config.inc.sample.php#L40

Note for developers
-------------------
- The default program to be loaded when a module is opened is not defined in the Search.php file anymore. Please update your custom modules' Menu.php file by adding the "default" entry, following this example https://gitlab.com/francoisjacquet/scholapro/blob/mobile/modules/Attendance/Menu.php#L3
...
Changes in 2.4.1
----------------
- Update 2014 SQL: add Resources table in scholapro2014.sql
...
- scholapro.sql for 2014: scholapro2014.sql
...
- Update french & spanish translations
- SQL bugfix: remove search + system_field in custom_fields INSERTS in scholapro.sql
...
- SQL bugfix ScholaPro ID assigned not numeric error
- Add School Fields:
...
- Link example parent to example student in scholapro.sql
...
Upgrade from 1.3x
-----------------
- execute those 3 SQL statements to fix ScholaPro database:
...
- removed staff_exceptions table data in scholapro.sql
- bugfix: SQL bug 'NULL' instead of NULL in InputFinalGrades.php
- relate users to Default School in scholapro.sql
- added translations


Changes in 1.1
---------------
- added link to scholapro.org in index.php
...
- added gettext on every string in ScholaPro
...
- bugfix: ListOutput.fnc.php bug ngettext when the plural form is not registered as this in the scholapro.po file
