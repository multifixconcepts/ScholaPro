 ...
 * From: ScholaPro <scholapro@yourdomain.com>
 *
...
function SendEmail( $to, $subject, $message, $reply_to = null, $cc = null, $attachments = [] )
{
	...
	/**
	 * Fix error Invalid address: (From) scholapro@localhost
	 *
	...
	{
		// Set Email address to send from: ScholaPro <scholapro@yourdomain.com>.
