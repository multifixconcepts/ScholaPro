 ...
 * Do not send notification if ScholaPro installed on localhost (Windows typically).
 *
 * @since 5.9
 *
 * @param int    $student_id Student ID.
 ...
 * Do not send notification if password not set.
 * Send notification even if ScholaPro installed on localhost (Windows typically)
