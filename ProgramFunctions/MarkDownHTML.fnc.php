 ...
 * @since 8.3   Add ScholaPro URL to image path.
 *
 * @global object $security
 *
 ...
 * @param  bool   $add_url_to_image_path Add ScholaPro URL to image path. Useful when HTML used in email to display remote images.
 *
 * @return string Sanitized input with HTML encoded single quotes
 */
