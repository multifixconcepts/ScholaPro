...
This plugin is part of [ScholaPro](https://www.scholapro.org)

Author François Jacquet

## Description

This plugin integrates ScholaPro with [Moodle LMS](https://moodle.org/). It lets you import Moodle users.

### WARNING & LIMITATION

The plugin is designed and intended for ONE school only in ScholaPro.

Users and courses can only be rolled ONCE in ScholaPro.
...
Please follow [this tutorial](https://gitlab.com/francoisjacquet/scholapro/wikis/Moodle-integrator-setup)
