	...
	&& $_REQUEST['PASSWORD'] !== '' )
{
	...
	elseif ( isset( $_COOKIE['ScholaPro'] ) )
	{
...
?>
	...
	<details class="about-scholapro">
		...
		<p class="center size-1">
			...
			<br />&copy; 2012-2025 <a href="https://www.scholapro.org" rel="noreferrer">ScholaPro</a>
		</p>
	</details>
...
elseif ( ! isset( $_REQUEST['create_account'] ) )
{
	...
	$redirect_to = empty( $_REQUEST['redirect_to'] )
		...
		str_replace(
			[ '&_ROSARIO_PDF=true', '&_ROSARIO_PDF', '&LO_save=1', '&bottomfunc=print' ],
			'',
