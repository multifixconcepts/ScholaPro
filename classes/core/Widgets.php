...
class Widgets
{
	...
	/**
	 * Build Widget
	 * Calls the all() method or the \ScholaPro\Widget_[name] class.
	 *
	 ...
	 */
	function build( $name, $class_prefix = '\ScholaPro\Widget_' )
	{
	...
	function custom( $extra_widgets, $class_prefix = 'Widget_' )
	{
		foreach ( $extra_widgets as $add_on => $widgets )
		{
			...
			foreach ( $widgets as $widget )
			{
				 ...
				 * Custom '\Addon_Name\Widget_' class prefix.
				 *
				 * @example namespace Hostel_Premium; class Widget_hostel_room implements \ScholaPro\Widget {...}
				 */
