...
if ( User( 'PROFILE' ) === 'admin' )
{
	// @since 12.2 Security: move ScholaPro version from Login screen to Portal
	echo '<p class="size-1">' . sprintf( _( '%s version %s' ), 'ScholaPro', ROSARIO_VERSION ) . '</p>';
}
...
function PHPCheck()
{
	...
	{
		$ret[] = 'ScholaPro requires PHP 5.5.9 to run, your version is : ' . PHP_VERSION;
	}
