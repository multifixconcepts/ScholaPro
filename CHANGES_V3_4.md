...
Changes in 4.9.8
----------------
- Fix SQL error set ScholaPro ID maxlength to 9 in General_Info.inc.php & Student.php
...
- program_config table: Add Allow Teachers to edit gradebook grades for past quarters option in Update.fnc.php, scholapro.sql & Configuration.php, sponsored by Santa Cecilia school
...
Changes in 4.8.3
----------------
- Add Install ScholaPro database script in InstallDatabase.php
...
- Move Studies Certificate title and Signatures HTML to Template in Transcripts.php, scholapro.sql, scholapro_es.sql & scholapro_fr.sql
...
- Update default school year to 2019 in scholapro.sql & config.inc.sample.php
...
- Change Pull-Down (Auto & Export), Select Multiple from Options, Text, Long Text columns type to text in Update.fnc.php & Fields.fnc.php & scholapro.sql
...
- Remove GPA / MP List program in GPAMPList.php, Menu.php & scholapro.sql
- Add CLASS_RANK_CALCULATE_MPS to config table in Update.fnc.php & scholapro.sql
...
- SQL performance: rewrite set_class_rank_mp() function in scholapro.sql & Update.fnc.php
- SQL remove calc_cum_gpa_mp() function & include it in t_update_mp_stats() trigger in scholapro.sql & Update.fnc.php
- Remove Calculate GPA program in CalcGPA.php, Menu.php, Help_en.php & scholapro.sql
...
- SQL eligibility_activities table: Add COMMENT column in Update.fnc.php & scholapro.sql
...
- gradebook_assignment_types table: Add CREATED_MP column in scholapro.sql & Update.fnc.php
...
- Spanish translation: "bimestre" => "trimestre" in es_ES.utf8/scholapro.po & help.po
...
- gradebook_assignments table: Add FILE column in scholapro.sql & Update.fnc.php
- gradebook_assignments table: Change DESCRIPTION column type to text in scholapro.sql & Update.fnc.php
...
- Add PASSWORD_STRENGTH to config table in Update.fnc.php & scholapro.sql
...
- Add DESCRIPTION column to courses table + when rolling Courses in scholapro.sql & Rollover.php
...
- SQL config table: Change config_value column type to text in scholapro.sql & Update.fnc.php
...
- Remove Honor Roll by Subject program in HonorRollSubject.php, Menu.php & scholapro.sql
...
- Remove "Add a School" program in Schools.php, Menu.php, scholapro.sql & Help_en.php
...
- Fix SQL error in calc_gpa_mp function on INSERT Final Grades for students with various enrollment records in scholapro.sql & Update.fnc.php
...
- Translate database fields to Spanish or French in scholapro_es.sql & scholapro_fr.sql
...
- Fix #244: Add DISPLAY_NAME to config table for every school in Configuration.php, scholapro.sql & Update.fnc.php, sponsored by Asian Hope
- Default school year is 2018 in scholapro.sql & config.inc.sample.php
...
- Fix Error: ScholaPro cannot connect to the PostgreSQL in diagnostic.php
...
- Gettext .pot file available in locale/en_US.utf8/LC_MESSAGES/scholapro.pot
...
- #218 Add DISPLAY_NAME to config table in scholapro.sql & Update.fnc.php
...
- Give teachers, parents & students access to Courses program in Scheduling/Menu.php & scholapro.sql
...
- #199 Add FAILED_LOGIN_LIMIT Config option in scholapro.sql & Update.fnc.php & Configuration.php
...
- Default school year is 2017 in scholapro.sql & config.inc.sample.php
...
- Add scholapro2017.sql for 2017 school year DB in scholapro2017.sql
...
- Fix SQL error when entering (Unweighted) GPA Value > 99.99 in scholapro.sql & Update.fnc.php
...
- Add link to ScholaPro Forum to Resources in scholapro.sql
...
- Add Marking Periods to parents & students in School_Setup/Menu.php & scholapro.sql
- Add Access Log, thanks to @dpredster in AccessLog.php, index.php, Update.fnc.php & scholapro.sql
