...
/**
 * ScholaPro URL: dir (site), or script (page), or request (includes request params)
 * Will detect https inside Docker or behind reverse proxy
 *
 * Given this URL: https://domain.com/scholapro/Modules.php?modname=Module/Program.php
 * @example dir: https://domain.com/scholapro/ (with trailing slash)
 * @example script: https://domain.com/scholapro/Modules.php
 * @example request: https://domain.com/scholapro/Modules.php?modname=Module/Program.php
