...
- [**Windows**](https://gitlab.com/francoisjacquet/scholapro/wikis/Installer-ScholaPro-sur-Windows)
- [**Mac**](https://gitlab.com/francoisjacquet/scholapro/-/wikis/How-to-install-ScholaPro-on-Mac-(macOS,-OS-X)) (en anglais)
- [**cPanel**](https://gitlab.com/francoisjacquet/scholapro/wikis/How-to-install-ScholaPro-on-cPanel) (en anglais)
- [**Softaculous**](https://gitlab.com/francoisjacquet/scholapro/-/wikis/How-to-install-ScholaPro-with-Softaculous) (en anglais)
- [**Docker**](https://github.com/francoisjacquet/docker-scholapro) (en anglais)
- **Ubuntu** (ou n'importe quelle distribution Linux basée sur Debian), voir ci-dessous

Si vous ne disposez pas des moyens techniques ou des compétences pour installer ScholaPro, vous pouvez souscrire à une offre hébergée sur https://www.scholapro.com/fr


Installer le paquet
-------------------

Décompressez la [dernière version](https://www.scholapro.org/fr/download/) de ScholaPro, ou bien clonez le dépôt git (et faites le checkout du tag de la [dernière version](https://gitlab.com/francoisjacquet/scholapro/-/releases)) dans un répertoire accessible depuis le navigateur. Éditez le fichier `config.inc.sample.php` afin de régler les variables de configuration et renommez-le `config.inc.php`.
...
- `$RosarioPath` Chemin complet vers l'installation de ScholaPro.
...
- `define( 'ROSARIO_POST_MAX_SIZE_LIMIT', 16 * 1024 * 1024 );` Limiter la taille de `$_POST` (16MB par défaut). Détails [ici](https://gitlab.com/francoisjacquet/scholapro/-/blob/mobile/Warehouse.php#L322).
...
Vous êtes maintenant prêt pour configurer la base de données de ScholaPro. Si vous avez accès à l'invite de commande sur votre serveur, ouvrez une fenêtre de terminal et suivez ces instructions.
...
[Guide de Configuration Rapide](https://www.scholapro.org/fr/quick-setup-guide/)

[Sécuriser ScholaPro](https://gitlab.com/francoisjacquet/scholapro/-/wikis/Secure-ScholaPro)
